...
public class ProductoAjustado implements Producto
{
     ...
     */
    @Override
    // toca agregar o restar el precio de los ingredeintes
    public int getPrecio( )
    {
    	int precio = productoBase.getPrecio();
    	for (Ingrediente ingre : agregados) {
    		precio += ingre.getCostoAdicional();
    	}
    	for (Ingrediente ingre : eliminados) {
    		precio -= ingre.getCostoAdicional();
    	}
        return precio;
    }
    ...
    // agregar a la lista. faltaba en la clase
